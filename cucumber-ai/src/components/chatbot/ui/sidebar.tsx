...
function useSidebar() {
  ...
  // console.log("sidebar collapse toggle clicked", context);
  ...
  (
    ...
    const setOpen = React.useCallback(
      (value: boolean | ((value: boolean) => boolean)) => {
        ...
        // console.log("sidebar collapse openstate", openState);
        document.cookie = `${SIDEBAR_COOKIE_NAME}=${openState}; path=/dashboard/ai-assistant; max-age=${SIDEBAR_COOKIE_MAX_AGE}`;
        window.dispatchEvent(
          new CustomEvent('sidebar:state', { detail: String(openState) })
        );
        // console.log("sidebar collapse cookie set", document.cookie);
      },
      [setOpenProp, open],
    );
